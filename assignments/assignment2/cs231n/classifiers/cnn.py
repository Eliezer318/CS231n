...
class ThreeLayerConvNet(object):
    ...
    [input_dim, num_filters] - [num_filters]
    ...
    def __init__(
        ...
        # with standard deviation equal to weight _scale; biases should be          #
        ...
        C, H, W = input_dim
        HP, WP = int(1 + (H - 2)/2), 1 + int((W - 2)/2)  # max pooling
    ...
    def loss(self, X, y=None):
        ...
        scores, last_cache = affine_forward(scores, W3, b3)
        pass
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(dout, last_cache)
